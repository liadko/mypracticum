...
interface DesktopAppProps {
    user: User
    onSaveSignature: (s: string) => Promise<void>
}

export default function DesktopApp({ user, onSaveSignature }: DesktopAppProps) {
    ...
    const [showSignatureModal, setShowSignatureModal] = useState(!user.signature)
