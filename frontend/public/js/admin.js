...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleImportSubmit(event) {
        ...
        try {
            const result = await api.importStudents(file, isDryRun);
            ...
            // Our fetchApi helper throws a useful error message
    ...
    async function handleApproveSubmit(event) {
        ...
        try {
            // REFACTORED: Call the apiClient
            const data = await api.approveEntries(ids);
    ...
    async function handleGroupSubmit(event) {
        ...
        try {
            // REFACTORED: Call the apiClient
            const data = await api.bulkAddManualEntries(entriesPayload);
