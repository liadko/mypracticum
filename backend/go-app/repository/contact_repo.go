...
type ContactRepo interface {
	...
	UserHasMentorExcept(ctx context.Context, userID uuid.UUID, email string, exceptContactID uuid.UUID) (bool, error)
	UserHasMentor(ctx context.Context, userID uuid.UUID, email string) (bool, error)
