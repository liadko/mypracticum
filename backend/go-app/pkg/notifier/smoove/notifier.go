...
// SmooveNotifier calls the Smoove CRM API to send emails.
type SmooveNotifier struct {
	BaseURL    string
	APIKey     string
...
func NewSmooveClient(baseURL, apiKey string) *SmooveNotifier {
	return &SmooveNotifier{
		BaseURL:    baseURL,
		APIKey:     apiKey,
...
func (c *SmooveNotifier) Send(ctx context.Context, destination, code string) error {
